...
public class Contact {
	...
	// CONSTRUCTOR
	/*
	 * The constructor takes first, last name, phone number, and address.
	 * The first thing it does is generates a new ID for the contactID.
	 *
	 * First name and last name are checked for null or blank fields. If
	 * either of those conditions are true, fill in the field with "NULL" so
	 * that something exists to make it clear it is a placeholder.
	 ...
	 *
	 * If the number field, is not exactly 10 characters then
	 * fill it with the placeholder '0000000000'.
	 *
	 * Address it like the names. If it is blank or null, set it to
