...
public class ContactTest {
	/*
	 * The following tests check the Contact class. The first five tests ensure that fields follow the 
	 * length limits (10 characters for first and last names, exactly 10 characters for the phone number, 
	 * and 30 characters for the address). The last four tests check that none of the fields are null. 
	 * ContactID isn't tested for being null because it can't be created that way, and it's not tested for updates 
	...
	void testContactAddressWithMoreThanThirtyCharacters() {
		Contact contact = new Contact("FirstName", "LastName", "PhoneNumbr",
				"This address should not exist because" + "it is so long the system should catch this and throw an error");
